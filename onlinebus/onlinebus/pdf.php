...
<?php
session_start();
if(isset($_SESSION['name'])&&isset($_SESSION['email']) && isset($_SESSION['s1']) && isset($_SESSION['s2']) && isset($_SESSION['s3']) && isset($_SESSION['s4'])){
$name=$_SESSION['name'];
...
$query = "SELECT * FROM seats1 WHERE username ='$name' && email='$uemail' && (s1='$s1' || s2='$s2' || s3='$s3' || s4='$s4')";
...
$pdf->Image("bus2.png");
$pdf->Cell(0,10,"Welcome to Hanif Enterprise",0,1,"C");
$pdf->Cell(0,10,"",0,1,"C");
...
$pdf->Cell(0,10,"at 01:00:00",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
