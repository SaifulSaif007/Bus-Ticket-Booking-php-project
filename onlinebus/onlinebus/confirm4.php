	...
	<body>
		...
		<div id = "menu">
			...
			if($_SERVER["REQUEST_METHOD"] == "POST"){
					...
					$result = mysql_query("SELECT * FROM `seats5` where s1 = ' ' || s2 = ' ' || s3 = ' ' || s4 = ' '")
						...
						$row = mysql_fetch_array($result);
							...
							if(mysql_num_rows($result) != 0){
								$result1 = mysql_query("UPDATE seats5 SET username = '$user',email = '$email',s1 = '$s1' where seats = '$c1' and s1 = ' '")
									or die("Failed to query  ".mysql_error());
									
				
								$result2 = mysql_query("UPDATE seats5 SET username = '$user',email = '$email',s2 = '$s2' where seats = '$c1' and s2 = ' '")
									or die("Failed to query  ".mysql_error());
									
					
								$result3 = mysql_query("UPDATE seats5 SET username = '$user',email = '$email',s3 = '$s3' where seats = '$c1' and s3 = ' '")
									or die("Failed to query  ".mysql_error());
							
								$result4 = mysql_query("UPDATE seats5 SET username = '$user',email = '$email',s4 = '$s4' where seats = '$c1' and s4 = ' '")
								or die("Failed to query  ".mysql_error());
