...
$query = "SELECT * FROM seats2 WHERE username ='$name' && email='$uemail' && (s1='$s1' || s2='$s2' || s3='$s3' || s4='$s4')";
...
$pdf->Image("bus2.png");
$pdf->Cell(0,10,"Welcome to Agomony Express",0,1,"C");
$pdf->Cell(0,10,"",0,1,"C");
...
$pdf->Cell(0,10,"at 02:00:00",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
$pdf->Cell(70,10,"",0,1,"C");
